...
class Passordtegn {
  ...
  public static final int FORSTETEGNSTALLVERDI = 33; // den fOrste av de skrivbare unntatt ' ' (mellomrom som er nr 32)
  ...
  public static final int ANTALL_SMA_BOKSTAVER = 'z' - 'a' + 1;  // f.o.m. a t.o.m. z
  ...
  public static boolean erPassordtegn(char tegn) {
     return tegn >= (char) FORSTETEGNSTALLVERDI && tegn <= (char) SISTETEGNSTALLVERDI;
  }
  ...
  public static char trekkLitenBokstav() {
    int tall = randomGen.nextInt(ANTALL_SMA_BOKSTAVER) + LITEN_AS_TALLVERDI;
        // nextInt() returnerer et heltall i intervallet [0, ANTALL_SMA_BOKSTAVER - 1]
    return (char) tall;
  }
  ...
  public static char trekkSpesialtegn() {
    ...
    while (erBokstavEllerSiffer((char) tall)) {
      tall = randomGen.nextInt((int) SISTETEGNSTALLVERDI - (int) FORSTETEGNSTALLVERDI + 1) + FORSTETEGNSTALLVERDI;
      /* nextInt() returnerer et heltall i intervallet [0, (int) SISTETEGNSTALLVERDI - (int) FORSTETEGNSTALLVERDI] */
    }
    return (char) tall;
  }
} // Passordtegn
